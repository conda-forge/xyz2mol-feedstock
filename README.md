...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xyz2mol-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14937&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xyz2mol-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xyz2mol` can be installed with:

```
conda install xyz2mol
```

It is possible to list all of the versions of `xyz2mol` available on your platform with:
